/**
 * Site content (generated by `npm run build` from content/defaults.json + content/cms/).
 * Do not edit by hand — use the CMS at /admin/ or run the build after changing JSON.
 */
window.SITE_CONTENT = {
  home: {
    /** Rotating hero images (RLMSS-style slider). First slide also used as fallback. */
    hero: {
      slides: [
    ...
    /** Right column card (RLMSS “Fund Raising Appeal” style). Click opens full fund appeal page. */
    fundraising: {
  ...
  /** Full fund appeal page — maintained in the CMS (Fund appeal). */
  fundAppeal: {
    ...
    /** Opens donate-payment.html (UPI, net banking, optional gateway). Or https://… payment link. */
    donateHref: "donate-payment.html",
    donors: [],
    /**
     * donate-payment.html: UPI / bank copy. Add gatewayUrl when you have Razorpay (or similar) for cards + UPI + netbanking in one flow.
     */
    paymentOptions: {
      intro:
        "Choose how you would like to donate. You can use UPI apps (Google Pay, PhonePe, Paytm, BHIM), internet banking, or the online gateway when available.",
      upiId: "",
      gatewayUrl: "",
  ...
  /** Home page quick announcements (CMS: Home page) */
  quickAnnouncements: [
    {
      datetime: "2026-03-28",
      date: "Mar 28, 2026",
  ...
  /** Flash image on Home — also merged into site settings for the modal (CMS: Flash news). */
  flashNews: {
    enabled: true,
